...
# for Manufacturing Trade flows from Structural Gravity Database
...
# Load data
data <- read.dta13("input/struc_2016_balanced.dta")
...
# Save processed data
saveRDS(dt, "input/ge_ppml_data_struc.rds")
...
# Load prepared data
dt <- readRDS("input/ge_ppml_data_struc.rds")
...
# Save results
saveRDS(dt, "output/rds/full_static_all_struc.rds")
...
saveRDS(imr_dt, "output/rds/imrs_all_struc.rds")
...
saveRDS(all_indexes, "output/rds/all_indexes_geppml_struc.rds")
